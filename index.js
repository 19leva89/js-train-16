...
function filterStudentsByGrade(students, grade) {
	// Виведе в консоль критичну помилку з текстом "Якщо ви бачите це повідомлення завдання 1 виконано не правильно"
	if ("умова, що перевіряє правильність результату") {
...
function logArrayElements(arr) {
	...
	for (let key in arr) {
		console.log(`Елемент ${key}: ${arr[key]}`);
	}
}
...
function compareArrays(arr1, arr2) {
	...
	for (let i = 0; i < arr1.length; i++) {
		console.assert(arr1[i] === arr2[i], "Масиви не однакові!");
	}
}

console.log("Завдання: 4 ==============================");
compareArrays([1, 5, 3, 4, 2], [2, 1, 3, 4]);
...
function buildMatrix(size) {
	...
	// Виводимо матрицю в консоль за допомогою push, як таблицю.
...
function validateUserInput(userInput) {
	// Перевіримо умову наявності імені користувача, якщо воно відсутнє виводимо "Помилка: ім'я користувача відсутнє!"
	// Перевіримо умову наявності паролю, якщо він відсутній виводимо "Помилка: пароль відсутній!"
...
function countVowelsAndConsonants(word) {
	...
	for (let letter of word.toLowerCase()) {
		...
		// Перевіряємо, чи є літера в нашому рядку з голосними, якщо так збільшуємо лічильник голосних, інакше приголосних
